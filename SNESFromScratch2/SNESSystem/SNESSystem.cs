...
namespace SNESFromScratch2.SNESSystem
{
    public class SNESSystem : ISNESSystem
    {
        ...
        private byte[] _dmaBadr = new byte[8];
        private ushort[] _dmaAadr = new ushort[8];
        private byte[] _dmaAadrBank = new byte[8];
        private ushort[] _dmaSize = new ushort[8];
        private byte[] _hdmaIndBank = new byte[8];
        private ushort[] _hdmaTableAdr = new ushort[8];
        private byte[] _hdmaRepCount = new byte[8];
        private byte[] _dmaUnusedByte = new byte[8];

        public int XPos { get; private set; }
        public int YPos { get; private set; }

        private int _cpuCyclesLeft = 5 * 8 + 12;
        ...
        private int _hTimer = 0x1ff;
        private int _vTimer = 0x1ff;
        private bool _inNmi;
        private bool _inIrq;
        ...
        public bool PPULatch { get; private set; } = true;
        ...
        private int _multiplyA = 0xff;
        private int _divA = 0xffff;
        private int _divResult = 0x101;
        private int _mulResult = 0xfe01;
        ...
        private bool[] _dmaActive = new bool[8];
        private bool[] _hdmaActive = new bool[8];

        private int[] _dmaMode = new int[8];
        private bool[] _dmaFixed = new bool[8];
        private bool[] _dmaDec = new bool[8];
        private bool[] _hdmaInd = new bool[8];
        private bool[] _dmaFromB = new bool[8];
        private bool[] _dmaUnusedBit = new bool[8];
        ...
        private void LoadRom(byte[] rom)
        {
            ...
            {
                var extraData = rom.Length - header.RomSize / 2;
