...
namespace SNESFromScratch2.PictureProcessing
{
    public class PPU : IPPU
    {
        ...
        private ushort[] _vram = new ushort[0x8000];
        private ushort[] _cgram = new ushort[0x100];
        private ushort[] _oam = new ushort[0x100];
        private ushort[] _highOam = new ushort[0x10];
        private byte[] _spriteLineBuffer = new byte[256];
        private byte[] _spritePrioBuffer = new byte[256];
        private int[] _mode7Xcoords = new int[256];
        private int[] _mode7Ycoords = new int[256];
        private int[] _pixelOutput = new int[57344];
        ...
        private bool[] _tilemapWider = new bool[4];
        private bool[] _tilemapHigher = new bool[4];
        private int[] _tilemapAdr = new int[4];
        private int[] _tileAdr = new int[4];

        private int[] _bgHoff = new int[5];
        private int[] _bgVoff = new int[5];

        private int _offPrev1;
        private int _offPrev2;
        private int _mode;
        private bool _layer3Prio;
        private bool[] _bigTiles = new bool[4];
        private bool[] _mosaicEnabled = new bool[5];
        private int _mosaicSize = 1;
        private int _mosaicStartLine = 1;
        private bool[] _mainScreenEnabled = new bool[5];
        private bool[] _subScreenEnabled = new bool[5];
        ...
        private bool[] _window1Inversed = new bool[6];
        private bool[] _window1Enabled = new bool[6];
        private bool[] _window2Inversed = new bool[6];
        private bool[] _window2Enabled = new bool[6];
        private int[] _windowMaskLogic = new int[6];
        private int _window1Left;
        private int _window1Right;
        private int _window2Left;
        private int _window2Right;
        private bool[] _mainScreenWindow = new bool[5];
        private bool[] _subScreenWindow = new bool[5];
        ...
        private bool[] _mathEnabled = new bool[6];
        private int _fixedColorB ;
        private int _fixedColorG;
        private int _fixedColorR;

        private int[] _tilemapBuffer = new int[4];
        private int[] _tileBufferP1 = new int[4];
        private int[] _tileBufferP2 = new int[4];
        private int[] _tileBufferP3 = new int[4];
        private int[] _tileBufferP4 = new int[4];
        private int[] _lastTileFetchedX = { -1, -1, -1, -1 };
        private int[] _lastTileFetchedY = { -1, -1, -1, -1 };
        private int[] _optHorBuffer = new int[2];
        private int[] _optVerBuffer = new int[2];
        private int[] _lastOrigTileX = { -1, -1 };
