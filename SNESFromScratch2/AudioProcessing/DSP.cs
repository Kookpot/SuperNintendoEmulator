...
namespace SNESFromScratch2.AudioProcessing
{
    ...
    {
        public float[] SamplesL { get; private set; } = new float[534];
        public float[] SamplesR { get; private set; } = new float[534];
        public int SampleOffset { get; set; }

        private IAPU _apu;
        private byte[] _ram = new byte[0x80];
        ...
        private short[] _decodeBuffer = new short[19 * 8];
        private short[] _rateNums = new short[5 * 8];

        private int[] _pitch = new int[8];
        private int[] _counter = new int[8];
        private bool[] _pitchMod = new bool[8];

        private int[] _srcn = new int[8];
        private int[] _decodeOffset = new int[8];
        private int[] _prevFlags = new int[8];
        private int[] _old = new int[8];
        private int[] _older = new int[8];
        private bool[] _enableNoise = new bool[8];

        private int _noiseSample = -0x4000;
        private int _noiseRate;
        private int _noiseCounter;

        private int[] _rateCounter = new int[8];
        private int[] _adsrState = { 3, 3, 3, 3, 3, 3, 3, 3 };
        private int[] _sustainLevel = new int[8];
        private bool[] _useGain = new bool[8];
        private int[] _gainMode = new int[8];
        private bool[] _directGain = new bool[8];
        private int[] _gainValue = new int[8];
        private int[] _gain = new int[8];
        private int[] _channelVolumeL = new int[8];
        private int[] _channelVolumeR = new int[8];
        ...
        private bool[] _noteOff = { true, true, true, true, true, true, true, true };

        private int[] _sampleOut = new int[8];
