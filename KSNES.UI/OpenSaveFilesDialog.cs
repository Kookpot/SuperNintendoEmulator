...
#pragma warning restore CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
    ...
    private List<SaveFileInfo> _lst = [];
...
#pragma warning restore CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
    ...
    private void OnFilterChange(object? sender, EventArgs args)
    {
        ...
        List<SaveFileInfo> lst =
        [
            .. _lst.Where(x => x.GameName.Contains(FilterTextBox.Text) || x.Name.Contains(FilterTextBox.Text))
    ...
    private void OpenSaveFilesDialog_Load(object sender, EventArgs e)
    {
        ...
        List<SaveFileInfo> lst = [.. _lst.OrderByDescending(x => x.DateTime)];
