...
namespace SNESFromScratch.Rendering
{
    public partial class OpenSaveFilesDialog : Form
    {
        ...
        public OpenSaveFilesDialog()
        {
            DialogResult = DialogResult.None;
            _renderer = new GDIRenderer();
            _systemManager = new SystemMananger();
            InitializeComponent();
        }
        ...
        private void OnFilterChange(object sender, EventArgs args)
        {
            ...
            var lst = _lst.Where(x => x.GameName.Contains(FilterTextBox.Text) || x.Name.Contains(FilterTextBox.Text))
